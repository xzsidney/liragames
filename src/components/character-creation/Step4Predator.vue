    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
        ...
        >
          ...
          <div v-if="store.form.predatorId === pkg.id" class="mt-3 pt-3 border-t border-blood-red/30 animate-fade-in">
            <p class="text-[10px] text-blood-red uppercase tracking-widest mb-2 font-bold">Ganhos da Caçada:</p>
