<template>
  <div class="min-h-screen bg-[#050505] text-parchment font-sans relative overflow-x-hidden selection:bg-blood-red selection:text-white">
    ...
    <nav class="relative z-20 border-b border-white/10 bg-black/70 backdrop-blur-md sticky top-0">
      <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 text-xs font-serif tracking-widest uppercase">
          <span class="text-gold-dim">Arsenal & Equipamentos</span>
    ...
    <main class="relative z-10 max-w-7xl mx-auto px-6 py-10">
      <!-- HEADER & TABS -->
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 pb-6 border-b border-white/10">
        <div>
          <h1 class="font-serif text-3xl md:text-4xl text-gold-dim">
